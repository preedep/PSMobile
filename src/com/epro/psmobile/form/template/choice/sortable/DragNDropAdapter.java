...
package com.epro.psmobile.form.template.choice.sortable;
...
public final class DragNDropAdapter extends ChoiceBaseAdapter implements RemoveListener, DropListener{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.textNumber = (TextView)convertView.findViewById(mIds[1]);
