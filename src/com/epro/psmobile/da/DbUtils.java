...
public class DbUtils {
     ...
     * @return number of statements executed.
     */
    public synchronized static int executeSqlScript(Context context, SQLiteDatabase db, String assetFilename, boolean transactional)
            throws IOException {
        ...
        Log.d("DEBUG_D","Executed " + count + " statements from SQL script '" + assetFilename + "'");
        return count;
    }

    public synchronized static int executeSqlStatementsInTx(SQLiteDatabase db, String[] statements) {
        db.beginTransaction();
        try {
    ...
    public synchronized  static int executeSqlStatements(SQLiteDatabase db, String[] statements) {
        int count = 0;
     ...
     */
    public synchronized static int copyAllBytes(InputStream in, OutputStream out) throws IOException {
        int byteCount = 0;
    ...
    public synchronized static byte[] readAllBytes(InputStream in) throws IOException {
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        copyAllBytes(in, out);
        return out.toByteArray();
    }

    public synchronized static byte[] readAsset(Context context, String filename) throws IOException {
    ...
    public synchronized static void logTableDump(SQLiteDatabase db, String tablename) {
